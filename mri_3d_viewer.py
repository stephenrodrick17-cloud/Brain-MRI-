#!/usr/bin/env python3
"""
3D MRI Reconstruction with Interactive 3D Viewer
Complete system with real-time 3D visualization using Three.js
"""
...
<head>
    ...
    <title>3D MRI Reconstruction - Interactive 3D Viewer</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Interactive 3D Visualization of 2D MRI Scans</p>
        </div>
        ...
        <div class="main">
            ...
            <div class="panel">
                ...
                <div class="controls-info">
                    <strong>3D Viewer Controls:</strong><br>
                    🖱️ Drag = Rotate<br>
                    🔄 Scroll = Zoom<br>
            ...
            <div>
                ...
                <div class="viewer-container" id="viewerContainer">
                    ...
                    <div class="viewer-info">
                        <div class="tabs">
                            <button class="tab-btn active" onclick="switchTab(0, 'view3d'); return false;">3D Viewer</button>
                            <button class="tab-btn" onclick="switchTab(1, 'metrics'); return false;">📊 Metrics</button>
                            <button class="tab-btn" onclick="switchTab(2, 'info'); return false;">ℹ️ Info</button>
                        </div>
                        <div class="tab-content active" id="view3d">
                            <p><strong>3D Volume Visualization</strong></p>
                            <p style="font-size: 0.85em; color: #888; margin-top: 8px;">Interactive 3D rendering of your MRI scan. The visualization shows the depth-estimated volume from your 2D image.</p>
                        </div>
    ...
    <script>
        ...
        function create3DVisualization(data) {
            ...
            // Create 3D box representing volume
        ...
        function displayMetrics(results) {
            const html = `
                ...
                <div class="metric">
                    ...
                    <div class="metric-value">${results.shape[0]}×${results.shape[1]}</div>
                </div>
            `;
        ...
        function switchTab(index, name) {
            try {
                ...
                if (buttons) buttons.forEach(function(b) { if (b) b.classList.remove('active'); });
                if (contents) contents.forEach(function(t) { if (t) t.classList.remove('active'); });
                
                if (buttons && buttons[index] && buttons[index].classList) buttons[index].classList.add('active');
                const nameEl = document.getElementById(name);
                if (nameEl && nameEl.classList) nameEl.classList.add('active');
            } catch (e) {
...
def process():
    try:
        ...
        print(f"[INFO] File: {file.filename}")
        ...
        print(f"[INFO] Shape: {img_array.shape}")
        ...
        print(f"[INFO] Volume created: {volume.shape}")
...
if __name__ == '__main__':
    print("\n" + "="*70)
    print("🏥 3D MRI RECONSTRUCTION - INTERACTIVE 3D VIEWER")
    print("="*70)
    print("\n✓ Server: http://localhost:5000")
    print("✓ Features: Interactive 3D viewer, Real-time rendering, Orbit controls")
    print("\n" + "="*70 + "\n")
